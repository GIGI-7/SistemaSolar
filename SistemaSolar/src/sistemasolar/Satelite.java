...
public class Satelite extends Astro {
	...
	public enum DatosSatelite {
		...
		TIERRA(1.0, ESCALA_ORBITA_SATELITE*0.01, ESCALA_ORBITA_SATELITE*0.00999, 1.0, "https://svs.gsfc.nasa.gov/vis/a000000/a002900/a002915/bluemarble-1024.png"),
		MARTE (0.7,ESCALA_ORBITA_SATELITE*0.019 ,ESCALA_ORBITA_SATELITE*0.019, 1.5, "http://images.all-free-download.com/images/graphiclarge/red_shading_background_05_hd_pictures_169759.jpg"),
    ...
    LUNAG2(0.273, ESCALA_ORBITA_SATELITE * 0.0026 	, ESCALA_ORBITA_SATELITE * 0.002569, 0.08, "https://brazenbelles.files.wordpress.com/2012/01/silver_glitter.jpg"),
		...
		PLUTON(1.0,  ESCALA_ORBITA_SATELITE * 0.0666, -ESCALA_ORBITA_SATELITE*0.066, 2.5, "https://www.fabric-textiles.com/images/cat/fabric/infinity/Passion-Suede$Copper_z.jpg");
		;
